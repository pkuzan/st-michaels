...
const unsigned long flashInterval = 1000UL;
  ...
  switch (state) {
    case STATE_STANDBY: {
        if (justTransitioned) {
          ...
          transitionLEDState(STATE_LED_RED);
    ...
    case STATE_COMPUTER_STARTING: {
        if (justTransitioned) {
          ...
          transitionLEDState(STATE_LED_AMBER);
    ...
    case STATE_RUNNING: {
        if (justTransitioned) {
          ...
          transitionLEDState(STATE_LED_GREEN);
